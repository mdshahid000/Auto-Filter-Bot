...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('🔔 MCU Movie', url='https://t.me/mcuinfinitysaga)
            ],
            [
                InlineKeyboardButton('⚡ Movies Group ⚡', url=f"https://t.me/movierequstgroup7"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ Movie Group ⚡', url=f"https://t.me/movierequstgroup7"),
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('JOIN', url='https://t.me/movierequstgroup7')] ] ),
        protect_content=True if pre == 'filep' else False,
        )
